...
if args.batch:
    ...
    mailsphinx.sphinx.batch(args.batch_directory, args.batch_filename_pattern_startswith, args.historical_mode_save_directory)
else:
    # Main program
    # CONVERT ARGS
    ...
    mailsphinx.sphinx.main(args.send_email, args.historical_mode, args.start_datetime, args.end_datetime, args.historical_mode_save_directory)
