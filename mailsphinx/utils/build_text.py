...
def build_text(is_historical=False, convert_images_to_base64=False, start_datetime=None, end_datetime=None):
    """
    ...
    # GET TIME BOUNDARIES
    if is_historical:
        week_start = pd.to_datetime(start_datetime)
        week_end = pd.to_datetime(end_datetime)
    else:
