...
function deleteRow() {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbwZexaRHlWjA-dRGSrcTnkoBx8ZZQejgYEa6rVtSZJz1IlEXswoK3QKty4a6623QLPL/exec?email=' + encodeURIComponent(email);
